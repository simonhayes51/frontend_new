...
const DesktopSidebar = () => {
  ...
  // base nav (same style as your reference)
  const navItems = [
    ...
    // Premium features
    { path: "/smart-buy", label: "Smart Buy", premium: true },
    { path: "/trade-finder", label: "Trade Finder", premium: true },
  ];
  ...
  return (
    ...
    >
          ...
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                ...
                {/* Right-side lock/crown when not premium */}
                {locked && !collapsed && (
                ...
                {/* Collapsed: small crown dot for locked */}
                {locked && collapsed && (
      ...
      {/* Footer: Premium link (replaces Help & Support) */}
      <div className={`${collapsed ? "px-2 py-2" : "px-2 py-3"} border-t border-gray-700/50 shrink-0`}>
        <div className="space-y-1">
          ...
          >
            ...
            {!collapsed && <span>{isPremium ? "Premium Active" : "Upgrade to Premium"}</span>}
          </Link>
        </div>
      </div>
    </aside>
