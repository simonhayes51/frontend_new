            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="flex items-end gap-2">
                <button
                  ...
                  onClick={() =>
                    fetch("/api/export/trades?format=csv", { credentials: "include" })
                      .then((r) => r.blob())
                      .then((b) => {
                ...
                <label className="px-3 py-2 rounded-lg border border-gray-800 bg-gray-900 text-gray-200 inline-flex items-center gap-2 cursor-pointer">
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      fd.append("file", f);
                      fetch("/api/import/trades", { method: "POST", body: fd, credentials: "include" })
                        .then((r) => r.json())
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    fetch("/api/data/delete-all?confirm=true", { method: "DELETE", credentials: "include" }).then(() =>
                      location.reload()
                    );
                  }}
                >
